...
const expressApp = () => {
  ...
  app
    ...
    .use(express.static(__dirname + '/public/stylesheets'))
    .use(express.static(__dirname + '/public/bundle.js'))
...
const startServer = () => serverFromApp(expressApp())
startServer.newApp = expressApp
